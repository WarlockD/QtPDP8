...
QT_MOC_LITERAL(4, 22, 13), // "putDataSignal"
QT_MOC_LITERAL(5, 36, 11), // "putDataSlot"
QT_MOC_LITERAL(6, 48, 1) // "c"

    },
    "Console\0getData\0\0data\0putDataSignal\0"
    "putDataSlot\0c"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getData((*reinterpret_cast< const QChar(*)>(_a[1]))); break;
        case 1: _t->putDataSignal((*reinterpret_cast< const QChar(*)>(_a[1]))); break;
        case 2: _t->putDataSlot((*reinterpret_cast< const QChar(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Console::*_t)(const QChar );
        ...
        {
            typedef void (Console::*_t)(const QChar );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Console::putDataSignal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Console::getData(const QChar _t1)
{
...
// SIGNAL 1
void Console::putDataSignal(const QChar _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
